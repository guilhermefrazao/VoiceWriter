...
class TopToolbar(ft.Container):
    def __init__(self, left_items=None, right_items=None, bgcolor="#181818", vertical_padding=0):
        super().__init__()
        self.bgcolor = bgcolor
        self.height = 40
        self.padding = ft.padding.symmetric(horizontal=15, vertical=vertical_padding)
